...
{
    public class KriterijService : BaseCRUDService<Models.Models.Kriterij, Database.Kriterij, BaseSearchObject, KriterijInsertRequest, KriterijUpdateRequest>, IKriterijService
    {
